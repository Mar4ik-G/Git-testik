window.addEventListener("DOMContentLoaded", function (event) {
    ...
    function fontFamily(element) {
        let always = document.getElementById('always_selected')
        let box = document.querySelectorAll(element)
        document.querySelector(".b9").addEventListener("change", function(e){
            const target = e.target
            const family = target.value
            box.value = always.value
            box.forEach(function(box){
    ...
    function fontSize(element) {
        let always1 = document.getElementById('always_selected1')
        let box = document.querySelectorAll(element)
        document.querySelector(".b10").addEventListener("change", function(e){
            const target = e.target
            const size = target.value
            box.value = always1.value
            box.forEach(function(box){
        ...
        function background(element) {
            ...
            document.querySelectorAll(".bgButton").forEach(function (e) {
                ...
                document.querySelector(".bg1").addEventListener("click", function () {
                    ...
                    document.querySelector(".bgcFiles").style.display = "none"
